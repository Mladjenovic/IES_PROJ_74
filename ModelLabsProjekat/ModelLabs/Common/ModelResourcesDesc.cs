...
{	
	...
	public class ModelResourcesDesc
	{
		...
		private void InitializeTypeIdsInInsertOrder()
		{
			...
			typeIdsInInsertOrder.Add(ModelCode.MARKETDOCUMENT);
		...
		private void InitializeNotSettablePropertyIds()
		{
			...
			notSettablePropertyIds.Add(ModelCode.MARKETDOCUMENT_PERIODS);
			notSettablePropertyIds.Add(ModelCode.MARKETDOCUMENT_TIMESERIES);
			notSettablePropertyIds.Add(ModelCode.PERIOD_POINTS);
			notSettablePropertyIds.Add(ModelCode.PERIOD_TIMESERIES);
			notSettablePropertyIds.Add(ModelCode.TIMESERIES_MEASUREMENTPOINTS);
